...
import { PauseProjectCommand } from '../pause-project.command';

@CommandHandler(PauseProjectCommand)
export class PauseProjectHandler implements ICommandHandler<
  PauseProjectCommand,
